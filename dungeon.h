...
#define teleport(pair) (d->telemap[pair[dim_y]][pair[dim_x]])
#define mapxy(x, y) (d->map[y][x])
#define fogxy(x, y) (d->fog[y][x])
#define telemapxy(x, y) (d->telemap[y][x])
...
typedef struct dungeon {
  ...
  terrain_type_t telemap[DUNGEON_Y][DUNGEON_X];
