...
public:
  char msg[71];
  class io_message_t *next;
};

static class io_message_t *io_head, *io_tail;
...
void io_display_tele(dungeon_t *d)
{
  int y, x;
  character_t *c;
